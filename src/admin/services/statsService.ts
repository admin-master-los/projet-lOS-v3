...
export const getDashboardStats = async (): Promise<DashboardStats> => {
  try {
    ...
    const [
      ...
      safeCount('contact'),
      safeCount('projects'),        // ⚠️ N'existe pas - Phase 7
      safeCount('blog_posts'),       // ⚠️ N'existe pas - Phase 8
      safeCount('services'),
      safeCount('sectors'),
      safeCount('navigation'),
      safeCount('skills'),           // ⚠️ N'existe pas - Phase future
      safeCount('chatbot_knowledge'), // ⚠️ N'existe pas - Phase 10
    ]);
