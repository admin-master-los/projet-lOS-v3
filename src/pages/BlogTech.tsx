...
// ✨ Import Supabase client existant
import { supabase } from '../lib/supabaseClient';

// ✨ Type pour les articles de blog (basé sur la structure de blog_posts)
interface BlogPost {
  id: string;
  title: string;
  excerpt: string;
...
// ✨ Main Blog Tech Component with Supabase
const BlogTech = () => {
  ...
  const fetchArticles = async () => {
    try {
      ...
      // ✨ Les données sont déjà au bon format grâce à la structure de la table
      setArticles(data || []);
    } catch (err) {
