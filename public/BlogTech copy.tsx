...
// ✨ Import des données depuis le fichier centralisé
import { generateDemoArticles, type BlogPostExtended } from '../data';
...
const BlogTech = () => {
  ...
  // ✨ Utilisation des articles depuis index.ts
  const articles = useMemo(() => generateDemoArticles(), []);
