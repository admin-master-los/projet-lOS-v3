...
const Sectors: React.FC = () => {
  ...
  const openModal = (sector: any, index: number) => {
    ...
    <section id="sectors" className="py-20 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {!loading && sectors.map((sector, index) => {
      ...
      {/* 🎭 MODALE IMMERSIVE FULL-SCREEN - STYLE DU FICHIER RÉFÉRENCE */}
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h2 className="text-3xl font-bold text-white mb-2">
                        {selectedSector.content_modal.hero_title}
                      </h2>
              ...
              <div className="bg-gradient-to-r from-cyan-500/20 to-purple-500/20 backdrop-blur-md border border-cyan-500/30 rounded-3xl p-12 text-center">
                ...
                >
                  ...
                  <span className="relative z-10 flex items-center gap-3">
                    ...
                    {selectedSector.content_modal.cta_text}
                  </span>
                </button>
              </div>
            </div>
